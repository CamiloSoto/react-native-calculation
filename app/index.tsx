    ...
    return (
        <View style={globalStyles.calculatorContainer}>
            ...
            <View style={globalStyles.row}>
                ...
                <CalculationButton label="/" color={Color.orang} onPress={divideOperation}/>
            </View>
            ...
            <View style={globalStyles.row}>
                ...
                <CalculationButton label="X" color={Color.orang} onPress={multiplyOperation}/>
            </View>
            ...
            <View style={globalStyles.row}>
                ...
                <CalculationButton label="-" color={Color.orang} onPress={subtrackOperation}/>
            </View>
            ...
            <View style={globalStyles.row}>
                ...
                <CalculationButton label="+" color={Color.orang} onPress={addOperation}/>
            </View>
            ...
            <View style={globalStyles.row}>
                ...
                <CalculationButton label="=" color={Color.orang} onPress={calculateResult}/>
            </View>
        </View>
    );
};
